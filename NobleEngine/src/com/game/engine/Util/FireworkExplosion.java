...
public class FireworkExplosion extends EntityFireworks
{
	Player[] players = null;

	public FireworkExplosion(World world, Player... p)
	{
		super(world);
		players = p;
		this.a(0.25F, 0.25F);
	...
	public static void spawn(Location location, FireworkEffect effect, Player... players)
	{
		try
		{
			FireworkExplosion firework = new FireworkExplosion(((CraftWorld) location.getWorld()).getHandle(), players);
